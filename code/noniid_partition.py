...
def non_iid_partition_with_dirichlet_distribution(label_list:np.ndarray,
                                                  ...
                                                  classes:int,
                                                  alpha:float,
                                                  task:str="classification") -> Dict[int,List[int]]:
    """
...
def _partition_class_samples_with_dirichlet_distribution(N:int,
                                                        alpha:float,
                                                        client_num:int,
                                                        idx_batch:list,
                                                        idx_k:np.ndarray,) -> Tuple[List[int],int]:
    """
    """
...
def record_data_stats(y_train:np.ndarray, net_dataidx_map:Dict[int,List[int]], task:str="classification") -> Dict[int,Dict[Any,int]]:
    """
    """
    net_cls_counts = {}
