...
class ImageFolder(Dataset):
    ...
    def make_data(self):
        classes_to_labels, classes_size = find_classes(
            os.path.join(self.raw_folder, "train")
        )
        train_img, train_label = make_img(
            os.path.join(self.raw_folder, "train"), classes_to_labels["label"]
        )
        test_img, test_label = make_img(
            os.path.join(self.raw_folder, "test"), classes_to_labels["label"]
        )
