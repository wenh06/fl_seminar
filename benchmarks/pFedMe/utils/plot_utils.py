...
def get_data_label_style(
    input_data=[], linestyles=[], algs_lbl=[], lamb=[], loc_ep1=0, batch_size=0
):
    data, lstyles, labels = [], [], []
...
def average_data(
    ...
    if algorithms == "PerAvg":
        algorithms = "PerAvg_p"
    glob_acc, train_acc, train_loss = get_all_training_data_value(
        num_users,
        loc_ep1,
        Numb_Glob_Iters,
        lamb,
...
def plot_summary_one_figure(
    ...
    plt.savefig(
        dataset.upper() + str(loc_ep1[1]) + "train_acc.png", bbox_inches="tight"
    )
    ...
    for i in range(Numb_Algs):
        plt.plot(
            train_loss[i, start:], linestyle=linestyles[i], label=algorithms_list[i]
        )
    ...
    plt.savefig(
        dataset.upper() + str(loc_ep1[1]) + "train_loss.png", bbox_inches="tight"
    )
    # plt.savefig(dataset + str(loc_ep1[1]) + 'train_loss.pdf')
    plt.figure(3)
    plt.grid(True)
    for i in range(Numb_Algs):
        plt.plot(glob_acc[i, start:], linestyle=linestyles[i], label=algorithms_list[i])
...
def get_max_value_index(
    ...
    for i in range(Numb_Algs):
        print(
            "Algorithm: ",
            algorithms_list[i],
            "Max testing Accurancy: ",
            glob_acc[i].max(),
            "Index: ",
            np.argmax(glob_acc[i]),
            "local update:",
            loc_ep1[i],
        )
...
def plot_summary_one_figure_synthetic_R(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
...
def plot_summary_one_figure_synthetic_K(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
...
def plot_summary_one_figure_synthetic_L(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
    ...
    for i in range(Numb_Algs):
        ...
        plt.plot(
            train_loss[i, 1:],
            linestyle=linestyles[i],
            label=label + ": " + r"$\lambda = $" + str(lamb[i]),
            linewidth=1,
            color=colors[i],
            marker=markers[i],
            markevery=0.05,
...
def plot_summary_one_figure_synthetic_D(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
...
def plot_summary_one_figure_synthetic_Compare(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
...
def plot_summary_one_figure_mnist_K(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
...
def plot_summary_one_figure_mnist_R(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
...
def plot_summary_one_figure_mnist_L(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
...
def plot_summary_one_figure_mnist_D(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
    ...
    for i in range(Numb_Algs):
        ...
        plt.plot(
            train_loss[i, 1:],
            linestyle=linestyles[i],
            label=label + r": $|\mathcal{D}|=$" + str(batch_size[i]),
            linewidth=1,
            color=colors[i],
            marker=markers[i],
            markevery=0.2,
...
def plot_summary_one_figure_mnist_Beta(
    num_users,
    loc_ep1,
    Numb_Glob_Iters,
    lamb,
