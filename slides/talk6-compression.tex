...
\begin{itemize}
    \item linear\_model\_with\_non\_convex\_loss/compressors.py
    \item neural\_nets\_experiments/compressors.py
\end{itemize}

\vspace{0.8em}

or \href{https://github.com/wenh06/fl_seminar/blob/master/code/compressors_test.ipynb}{this jupyter notebook}
