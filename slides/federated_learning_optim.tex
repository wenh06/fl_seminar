...
\node[client] (server) {server $\mathbf{w}$};
\node[client, below left = 1.5cm and 3cm of server.south] (client-1) {client $\mathbf{w}_1$};
\node[client, below left = 1.5cm and 1cm of server.south] (client-2) {client $\mathbf{w}_2$};
\node[client, below left = 1.5cm and -1cm of server.south] (client-3) {client $\mathbf{w}_3$};
\node[client missing, below left = 1.3cm and -2.8cm of server.south] {};
\node[client, below left = 1.5cm and -4cm of server.south] (client-n) {client $\mathbf{w}_n$};
