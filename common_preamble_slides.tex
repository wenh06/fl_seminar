...
\makeatletter
\beamer@headheight=3\baselineskip
\makeatother
...
\usepackage{dashbox}
\usepackage{tikz}
\usetikzlibrary{trees,arrows,decorations.pathmorphing,decorations.pathreplacing,shapes,shapes.geometric,backgrounds,positioning,calc,tikzmark,external}
\usepackage{xcolor}
\usepackage{hyperref}
...
% \usepackage{soul}
% \newcommand{\ulhref}[2]{\hyperref[#1]{\color{zkblue}\setulcolor{zkblue}\ul{#2}}}
